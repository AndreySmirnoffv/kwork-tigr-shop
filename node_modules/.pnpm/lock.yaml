...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      '@types/cookie-parser':
        specifier: ^1.4.8
        version: 1.4.8(@types/express@5.0.3)
      '@types/cors':
        specifier: ^2.8.19
        version: 2.8.19
      '@types/express':
...
packages:
  ...
  googleapis@149.0.0:
    resolution: {integrity: sha512-LTMc/njwYy7KTeaUHDcQt7KxftHyghdzm2XzbL46PRLd1AXB09utT9Po2ZJn2X0EApz0pE2T5x5A9zM8iue6zw==}
    engines: {node: '>=14.0.0'}
...
snapshots:
  ...
  '@types/cookie-parser@1.4.8(@types/express@5.0.3)':
    dependencies:
      '@types/express': 5.0.3
